...
function get_image_rootdevice_identifier($lvm_nfs_storage_id) {
	...
	// send command
	$resource_command="$OPENQRM_SERVER_BASE_DIR/openqrm/plugins/xen-storage/bin/openqrm-xen-storage post_identifier -u $OPENQRM_ADMIN->name -p $OPENQRM_ADMIN->password";
